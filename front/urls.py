...
urlpatterns = [
    ...
    url(r'^tarjeta/(?P<id>.*)$', views.tarjeta, name = 'tarjeta'),
    ...
    url(r'^empresa/(?P<id>.*)$', views.empresa, name = 'empresa'),
    url(r'^resolucion/(?P<id_entidad>.*)/(?P<id>.*)$', views.resolucion_entidad, name = 'resolucion_entidad'),
    url(r'^resoluciones/(?P<entidad_id>.*)$', views.resoluciones_entidad, name = 'resoluciones_entidad'),
]
